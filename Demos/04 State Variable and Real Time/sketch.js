...
function keyPressed(){
  ...
  // state var: 0 -> 1  1 -> 2    2 -> 3 for 2 seconds -> 0
  if (shapeState < 3){
    shapeState ++;
    if (shapeState === 3){
      startTime = millis()
...
function drawShape(){
  // Inspect state variable, and draw 1 of 4 possible options, depending on th current value
  switch(shapeState){
    case 0: 
